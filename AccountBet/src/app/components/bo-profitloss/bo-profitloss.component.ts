...
@Component({
  selector: 'app-bo-profitloss',
  templateUrl: './bo-profitloss.component.html',
  styleUrls: ['./bo-profitloss.component.scss']
})
export class BoProfitlossComponent implements OnInit {
  ...
  GetProfitLoss() {
    ...
    this.reportService.BOProfitLoss(pnldates.fromdate, pnldates.todate).subscribe(
      (resp: any) => {
        if (this.stype == '') {

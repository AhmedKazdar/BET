(function (global, factory) {
...
})(this, (function (exports, i1, i0, operators) { 'use strict';
    ...
    var ChartEditorRef = /** @class */ (function () {
        function ChartEditorRef(editor) {
            this.editor = editor;
            this.doneSubject = new i1.Subject();
    ...
    var GOOGLE_CHARTS_LAZY_CONFIG = new i0.InjectionToken('GOOGLE_CHARTS_LAZY_CONFIG', {
        ...
        factory: function () {
            ...
            return i1.of(Object.assign(Object.assign({}, getDefaultConfig()), (configFromModule || {})));
        }
    });
    ...
    var ScriptLoaderService = /** @class */ (function () {
        function ScriptLoaderService(zone, localeId, config$) {
            ...
            this.scriptLoadSubject = new i1.Subject();
        }
        /**
        ...
        ScriptLoaderService.prototype.loadChartPackages = function () {
            ...
            return this.loadGoogleCharts().pipe(operators.mergeMap(function () { return _this.config$; }), operators.map(function (config) {
                ...
                return new i1.Observable(function (observer) {
                    var config = {
                        packages: packages,
    ...
    ScriptLoaderService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ScriptLoaderService, deps: [{ token: i0__namespace.NgZone }, { token: i0.LOCALE_ID }, { token: GOOGLE_CHARTS_LAZY_CONFIG }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ScriptLoaderService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ScriptLoaderService });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ScriptLoaderService, decorators: [{
                type: i0.Injectable
    ...
    var ChartEditorComponent = /** @class */ (function () {
        function ChartEditorComponent(scriptLoaderService) {
            ...
            this.initializedSubject = new i1.Subject();
        }
    ...
    ChartEditorComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ChartEditorComponent, deps: [{ token: ScriptLoaderService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ChartEditorComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ChartEditorComponent, selector: "chart-editor", host: { classAttribute: "chart-editor" }, ngImport: i0__namespace, template: "<ng-content></ng-content>", isInline: true, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ChartEditorComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    ***************************************************************************** */
    ...
    DataTableService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: DataTableService, deps: [], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    DataTableService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: DataTableService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: DataTableService, decorators: [{
                type: i0.Injectable,
    ...
    var ControlWrapperComponent = /** @class */ (function () {
        function ControlWrapperComponent(loaderService) {
            ...
            this.wrapperReadySubject = new i1.ReplaySubject(1);
        }
    ...
    ControlWrapperComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ControlWrapperComponent, deps: [{ token: ScriptLoaderService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ControlWrapperComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ControlWrapperComponent, selector: "control-wrapper", inputs: { for: "for", type: "type", options: "options", state: "state" }, outputs: { error: "error", ready: "ready", stateChange: "stateChange" }, host: { properties: { "id": "this.id" }, classAttribute: "control-wrapper" }, exportAs: ["controlWrapper"], usesOnChanges: true, ngImport: i0__namespace, template: '', isInline: true, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ControlWrapperComponent, decorators: [{
                type: i0.Component,
                args: [{
        ...
        DashboardComponent.prototype.createDashboard = function () {
            ...
            var chartsReady$ = this.controlWrappers
                ...
                if (Array.isArray(charts)) {
                    ...
                    return i1.combineLatest(charts.map(function (chart) { return chart.wrapperReady$; }));
                }
                else {
            ...
            i1.combineLatest(__spreadArray(__spreadArray([], __read(controlWrappersReady$)), __read(chartsReady$))).subscribe(function () {
    ...
    DashboardComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: DashboardComponent, deps: [{ token: i0__namespace.ElementRef }, { token: ScriptLoaderService }, { token: DataTableService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    DashboardComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: DashboardComponent, selector: "dashboard", inputs: { data: "data", columns: "columns", formatters: "formatters" }, outputs: { ready: "ready", error: "error" }, host: { classAttribute: "dashboard" }, queries: [{ propertyName: "controlWrappers", predicate: ControlWrapperComponent }], exportAs: ["dashboard"], usesOnChanges: true, ngImport: i0__namespace, template: '<ng-content></ng-content>', isInline: true, changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: DashboardComponent, decorators: [{
                type: i0.Component,
                args: [{
                        selector: 'dashboard',
                        template: '<ng-content></ng-content>',
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: ScriptLoaderService }, { type: DataTableService }]; }, propDecorators: { data: [{
                    type: i0.Input
                }], columns: [{
                    type: i0.Input
                }], formatters: [{
    ...
    var GoogleChartComponent = /** @class */ (function () {
        ...
        GoogleChartComponent.prototype.updateResizeListener = function () {
            ...
            if (this.dynamicResize) {
                this.resizeSubscription = i1.fromEvent(window, 'resize', { passive: true })
    ...
    GoogleChartComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GoogleChartComponent, deps: [{ token: i0__namespace.ElementRef }, { token: ScriptLoaderService }, { token: DataTableService }, { token: DashboardComponent, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Component });
    GoogleChartComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: GoogleChartComponent, selector: "google-chart", inputs: { type: "type", data: "data", columns: "columns", title: "title", width: "width", height: "height", options: "options", formatters: "formatters", dynamicResize: "dynamicResize" }, outputs: { ready: "ready", error: "error", select: "select", mouseover: "mouseover", mouseleave: "mouseleave" }, host: { classAttribute: "google-chart" }, exportAs: ["googleChart"], usesOnChanges: true, ngImport: i0__namespace, template: '', isInline: true, styles: [":host { width: fit-content; display: block; }"], changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GoogleChartComponent, decorators: [{
                type: i0.Component,
                args: [{
            ...
            return [{ type: i0__namespace.ElementRef }, { type: ScriptLoaderService }, { type: DataTableService }, { type: DashboardComponent, decorators: [{
                            type: i0.Optional
                        }] }];
        }, propDecorators: { type: [{
                    type: i0.Input
    ...
    ChartWrapperComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ChartWrapperComponent, deps: [{ token: i0__namespace.ElementRef }, { token: ScriptLoaderService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ChartWrapperComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ChartWrapperComponent, selector: "chart-wrapper", inputs: { specs: "specs" }, outputs: { error: "error", ready: "ready", select: "select" }, host: { classAttribute: "chart-wrapper" }, exportAs: ["chartWrapper"], usesOnChanges: true, ngImport: i0__namespace, template: '', isInline: true, styles: [":host { width: fit-content; display: block; }"], changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ChartWrapperComponent, decorators: [{
                type: i0.Component,
                args: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: ScriptLoaderService }]; }, propDecorators: { specs: [{
                    type: i0.Input
                }], error: [{
                    type: i0.Output
                }], ready: [{
    ...
    GoogleChartsModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GoogleChartsModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    GoogleChartsModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GoogleChartsModule, declarations: [GoogleChartComponent,
    ...
    GoogleChartsModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GoogleChartsModule, providers: [ScriptLoaderService] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GoogleChartsModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
